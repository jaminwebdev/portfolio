<template>
  <nav class="appNav myContainer">
    <div class="appNav__logo">
      <NuxtLink to="/" class="appNav__menuLink">
        <img
          src="/logo--blue.svg"
          alt="main website logo in blue"
          v-if="getColorMode === 'light'"
        />
        <img
          src="/logo--white.svg"
          alt="main website logo in white"
    ...
    <div class="appNav__menu">
      ...
      <div class="appNav__mobileToggle" @click="$emit('toggleMobileMenu')">
        <img
          src="/icons/icon-hamburger-blue.svg"
          alt="mobile hamburger menu icon"
          v-if="getColorMode === 'light'"
        />
        <img
          src="/icons/icon-hamburger-white.svg"
          alt="mobile hamburger menu icon"
          v-if="getColorMode === 'dark'"
        />
      </div>
